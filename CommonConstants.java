...
public class CommonConstants {
    ...
    public static final int[] APP_SIZE = {400, 600};  //{width , hignt}

    // TEXTFILD CONFIGS 
    public static final int TEXTFILD_LENGTH = 10;
    public static final int TEXTFILD_FONTSIZE = 36;
    // public static final int TEXTFILD_SPRIGLAYOUT_NORTHPAD = 30;
    // public static final int TEXTFILD_SPRINGLAYOUT_WESTPAD = 36;
